...
/**
 * A value that may be a raw value, a Signal, or a Computed.
 *
 ...
 * ```
 */
export type MaybeSignal<T> = T | Signal<T> | Computed<T>;

/**
 * Extracts the current value from a Signal, Computed, or returns the
 ...
 *
 * @template T - The underlying value type
 * @param source - A plain value, Signal, or Computed
